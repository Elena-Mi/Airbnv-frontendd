...
export default function PlacesFormPage() {
    ...
    async function savePlace(ev) {
        ...
        if (id) {
            await axios.put('https://airbnv-backend.onrender.com/api/places', {
                id, ...placeData
            });
            ...
            await axios.post('https://airbnv-backend.onrender.com/api/places', placeData);
            setRedirectToPlacesList(true);
        }
    }
    ...
    return (
        <div>
                <AccountNav/>
                    <form method="post" onSubmit={savePlace}>
